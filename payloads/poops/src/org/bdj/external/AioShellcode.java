...
public class AioShellcode {
    ...
    private static final String BIN_PATH = "/org/bdj/external/kexp_quieter.bin";
    private static final String ELFLDR_PATH = "/org/bdj/external/elfldr_quieter_for_kexp.elf";
